...
* Enhancement: The `new` LLVM IR to BIR converter is now the default backend's converter. In most cases, this will improve code structure and significantly speed up the decompilation.
